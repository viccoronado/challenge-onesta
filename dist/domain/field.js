...
__decorate([
    (0, typeorm_1.ManyToOne)(() => farmer_1.Farmer, (farmer) => farmer.fields),
    __metadata("design:type", farmer_1.Farmer)
], Field.prototype, "farmer", void 0);
exports.Field = Field = __decorate([
    (0, typeorm_1.Entity)(),
    (0, typeorm_1.Unique)(['name', 'location'])
], Field);
